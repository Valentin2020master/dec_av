document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchPTData(pt) {
        try {
            const response = await fetch('../functions/fetch_pt_data3.php', {
                method: 'POST',
    ...
    async function updateCheckboxState(checkbox) {
        try {
            const response = await fetch('../functions/update_checkbox_state3.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
    ...
    async function fetchInitialCheckedItems() {
        try {
            const response = await fetch('../functions/get_checked_items3.php');
            if (response.ok) {
