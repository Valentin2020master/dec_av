document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchPTData(pt) {
        try {
            const response = await fetch('../functions/fetch_pt_data1.php', {
                method: 'POST',
    ...
    async function updateCheckboxState(checkbox) {
        try {
            const response = await fetch('../functions/update_checkbox_state1.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
    ...
    async function fetchInitialCheckedItems() {
        try {
            const response = await fetch('../functions/get_checked_items1.php');
            if (response.ok) {
